...
<div class="main dashboard-main animate-left">
    <div id="dashboard" class="dashboard-tab container row">
        <div class="col padding-left padding-bottom padding-right">
            ...
            <a href="readQr" data-animation="forward" class="btn margin-top theme radius padding-large left">
            ...
            <div class="right padding-16 pointer color-text-gray">
                <div id="login-aside" onclick="logoutDashboard()">
                    <i class="material-icons left padding-tiny">exit_to_app</i>
                    <div class="left padding-tiny">sair</div>
                </div>
            </div>
        </div>
